...
# ╔═╡ 5c2e568f-6785-4e60-86e3-2210a453efa8
...
let
    ...
    ax = Axis(fig[1, 1])
    for n in 0:5
        lines!(ax, 0..5, x -> normalize(Charlier(; a = 1)[n])(x))
    end
    fig
end
...
# ╔═╡ ecfe88c4-da74-4273-8dd6-b973a369a3d9
...
manifest_format = "2.0"
project_hash = "100634cff48e153ecdfaa679dbeddb413f99961b"
...
git-tree-sha1 = "e45a48f30607284fb2aefc7a03f4f18e2ee6dee2"
uuid = "e134572f-a0d5-539d-bddf-3cad8db41a82"
version = "301.300.101+0"
